...
class MainWindow:
    ...
    def __init__(self):
        ...
        style.configure("Parts.Treeview", rowheight=20, background="#0000000")
        ...
        self.table.place(x=10, y=10, width=350, height=350)
        ...
        self.water_progress = ttk.Progressbar(self.window, orient="vertical", mode="determinate", length=120,
                                              maximum=100, style="blue.Vertical.TProgressbar")
        self.water_progress.place(x=60, y=370, width=70)
    ...
    def update_product_info(self):
        try:
            self.img = ImageTk.PhotoImage(Image.open(self.selected_product.photo).resize((100, 100)))
        except Exception:
            self.img = ImageTk.PhotoImage(Image.open("default.png").resize((100, 100)))
    ...
    def append_product(self, prod, weight):
        try:
            self.img = ImageTk.PhotoImage(Image.open(prod.photo).resize((100, 100)))
        except Exception:
            self.img = ImageTk.PhotoImage(Image.open("default.png").resize((100, 100)))
        self.photos.append(self.img)
        self.table.insert("", 'end', text="",
...
class NewProductWindow(tk.Toplevel):
    ...
    def __init__(self, parent, main_window):
        ...
        self.carb_spin.place(x=22, y=142, width=55)

        self.label = tk.Label(self.window, text="Калории")
        self.label.place(x=22, y=170)

        self.calorie_spin = tk.Spinbox(self.window, from_=0, to=999)
        self.calorie_spin.place(x=22, y=192, width=55)
        ...
        self.text_box.place(x=150, y=125, height=20, width=110)
        ...
        self.submit.place(x=150, y=150, width=110)

        self.add_photo_butt = tk.Button(self.window, command=self.add_photo, borderwidth=1, text="+",
                                        font="Helvetica 15", bg=bg_color)
        self.add_photo_butt.place(x=265, y=125, height=20, width=20)

        self.drop_base_butt = tk.Button(self.window, command=self.DROP_DATABASE_NAHOI, borderwidth=1, text="⭕",
                                        bg=bg_color)
        self.drop_base_butt.place(y=5, x=375, height=20, width=20)
